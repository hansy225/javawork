...
public class T01_2Array {
	...
	public static void main(String[] args) {
		...
		// 배열을 선언하면서 값을 넣을 때
		int [][] score = {{1, 2, 3, 4, 5},  // [0] 행의 index 번호
						  {6, 7, 8, 9, 0},        // [1]
						  {7, 6, 5, 4, 3}};	// [2]
		...
		System.out.println("score2의 행의 길이 : " +score2.length);
		System.out.println("score2[0]의 열의 길이 : " +score2[0].length);
		System.out.println("score2[1]의 열의 길이 : " +score2[1].length);
		System.out.println("score2[2]의 열의 길이 : " +score2[2].length);
		System.out.println("------------------------");
